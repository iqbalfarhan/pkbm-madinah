...
type UserBulkForceDeleteProps = PropsWithChildren & {
  userIds?: number[];
  onSuccess?: () => void;
};

const UserBulkForceDelete: FC<UserBulkForceDeleteProps> = ({ children, userIds, onSuccess }) => {
  ...
  const handleSubmit = () => {
    destroy(route('user.bulk-force-delete'), {
      preserveScroll: true,
      onSuccess: () => {
...
export default UserBulkForceDelete;
